...
# --- 🧠 ULTRA MINIMALIST & TRANSPARAN SİTE CSS ENJEKSİYONU ---
st.markdown("""
    <style>
        /* Sayfa boşluklarını sıfırla ve arka planı sabitle */
        ...
        /* Streamlit Butonlarını ve Aksiyon Elemanlarını Transparan Yap */
...
while True:
    ...
    # Sağ üst saat alanı da tamamen şeffaf ve sade bir yazıya dönüştü
